...
const Testimonials = () => {
  return (
    <section
      id="testimonials"
      className="mb-24 px-6 lg:px-16 py-12 bg-base-100 text-base-content bg-cover"
      style={{ backgroundImage: `url(${TestimonialsSection.image})` }}
    >
      <div className="container bg-base-100/80 rounded-lg p-8">
        {/* Heading */}
        <h2 className="text-4xl font-bold text-center mb-4">{TestimonialsSection.heading}</h2>
